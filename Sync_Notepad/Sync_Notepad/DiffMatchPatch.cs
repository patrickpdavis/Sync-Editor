 ...
 * 
 * This code has been edited by Zachary Taylor and Patrick Davis for 
 * use with Sync-Note-Pad Editor. The edits consist of only the necessary
 * Data attributes to make the classes serializable.
 */
